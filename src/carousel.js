  ...
  getTouchEvents() {
    ...
    return {
      ...
      onTouchMove(e) {
        ...
        self.touchObject.length = Math.round(Math.sqrt(Math.pow(self.touchObject.endY - self.touchObject.startY, 2) + Math.pow(self.touchObject.endX - self.touchObject.startX, 2)));
